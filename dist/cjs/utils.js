...
var equals = exports.equals = function equals() {
  ...
  var _compare = function compare(o1, o2) {
    ...
    if ((0, _is.isArray)(o1) || (0, _is.isObject)(o1)) {
      if (seen.has(o1)) return seen.get(o1) === o2;
      seen.set(o1, o2);
    }
    if ((0, _is.isArray)(o1) || (0, _is.isArray)(o2)) {
      if (!(0, _is.isArray)(o1) || !(0, _is.isArray)(o2)) return false;
 ...
 */
var sizeOf = exports.sizeOf = function sizeOf(v) {
  return (0, _traversal.map)(v, noop).length;
};
...
var _flatten = exports.flatten = function flatten(o) {
  if ((0, _is.isObject)(o) || (0, _is.isArray)(o)) {
    return [].concat.apply([], (0, _traversal.map)(o, function (_, val) {
      return _flatten(val);
    }));
  }
  return o;
