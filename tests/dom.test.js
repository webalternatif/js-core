...
describe('dom manipulation', () => {
    ...
    describe('collide()', () => {
        ...
        it('should return false when separated', () => {
            ...
            el1.getBoundingClientRect = jest.fn(() => ({ x: 0, y: 0, height: 100, width: 200 }));
            el2.getBoundingClientRect = jest.fn(() => ({ x: 500, y: 500, height: 100, width: 200 }));
        ...
        it('should consider touching edges not as collision', () => {
            ...
            el1.getBoundingClientRect = jest.fn(() => ({ x: 0, y: 0, height: 100, width: 200 }));
            el2.getBoundingClientRect = jest.fn(() => ({ x: 200, y: 100, height: 100, width: 200 }));
    ...
    describe('offset()', () => {
        ...
        it('should return scroll offsets for document', () => {
            Object.defineProperty(document.documentElement, 'scrollLeft', { value: 10, configurable: true });
